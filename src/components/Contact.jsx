  ...
  return (
    <section className="mt-12 rounded-[28px] p-6 md:p-10 text-center">
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] items-center gap-6">
        <div>
          <div className="text-xs font-semibold tracking-[.18em] text-secondary uppercase">
            {t("contact_section_label")}
          </div>

          <h2 className="mt-2 text-2xl md:text-3xl font-extrabold text-primary">
            {t("contact_title")}
          </h2>
        </div>
      </div>
      ...
      <p className="text-secondary max-w-[70ch] m-auto mb-10">
        {t("contact_desc")}
      </p>
      <div>
        <a
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-primary mt-10">
        <div className="flex flex-col gap-2">
          ...
          <div className="text-sm text-secondary">{t("flavored_desc")}</div>
        </div>
